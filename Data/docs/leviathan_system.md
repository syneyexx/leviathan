...
>
> This is the implementation truth for the repository as of **Wave 11 Product Unification** (`0.75.0-wave11-product-unification`) on Wave 10 Production Ops (v33) + Wave 9 Post-Training Flywheel (v32) + Wave 8 Data/Training Factory (v31) + Wave 7 Multimodal (v30) + Wave 6 Coding/Research (v29) + Wave 5 Capability World (v28) + Wave 4 Context Substrate (v27) + Wave 3 Model Serving (v26) + Wave 2 Evaluation (v25) + Wave 1 Cognition + Wave 0 Durable Kernel (v24).
>
...
- SQLite persistence + migrations through **v32**;
...
- Production GRPO/PPO fleets; automatic silent production model swap;
