...
>
> This is the implementation truth for the repository as of **Wave 7 Multimodal + Realtime** (`0.71.0-wave7-multimodal`) on Wave 6 Coding/Research (v29) + Wave 5 Capability World (v28) + Wave 4 Context Substrate (v27) + Wave 3 Model Serving (v26) + Wave 2 Evaluation (v25) + Wave 1 Cognition + Wave 0 Durable Kernel (v24).
>
...
- SQLite persistence + migrations through **v30**;
...
- Honest stubs when features off; Media/Voice fixture workers (not ffmpeg/Whisper/TTS); Browser fixture worker (not Chromium);
