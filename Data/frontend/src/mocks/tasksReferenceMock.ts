...
export const TASKS_CARDS: TaskCard[] = [
  {
    ...
    priority: "Low",
    tag: "Market Research",
    description: "Analyze key markets in APAC for 2025...",
  ...
  },
  {
    ...
    priority: "Medium",
    tag: "Product",
    description: "Create v2 wireframes and user flows...",
    assignee: "Emma Park",
  ...
  },
  {
    ...
    priority: "Low",
    tag: "Finance",
    description: "Review international tax structures...",
  ...
  },
  {
    ...
    priority: "High",
    tag: "Finance",
    description: "Update model with latest projections...",
    assignee: "Alex Chen",
  ...
  },
  {
    ...
    priority: "High",
    tag: "Platform",
    description: "Add long-term memory for agents...",
  ...
  },
  {
    ...
    priority: "Medium",
    tag: "Investors",
    description: "Q2 progress, traction, and roadmap...",
    assignee: "Alex Chen",
    assigneeRole: "Founder",
    date: "Apr 24",
    progress: 80,
  ...
  },
  {
    ...
    priority: "Medium",
    tag: "Design",
    description: "Final visual polish and animations...",
    assignee: "Emma Park",
    assigneeRole: "Product Designer",
    date: "Apr 23",
    progress: 90,
  ...
  },
  {
    ...
    priority: "High",
    tag: "Legal",
    description: "Review terms with counsel...",
    assignee: "Sarah Kim",
  ...
  },
  {
    ...
    priority: "Medium",
    tag: "Trading",
    description: "Analyze latest backtest results...",
  ...
  },
  {
    ...
    priority: "Medium",
    tag: "Research",
    description: "Completed provider analysis...",
    assignee: "Research Agent",
    date: "Apr 21",
    progress: 100,
  ...
  },
  {
    ...
    priority: "Low",
    tag: "Design",
    description: "Brand assets and guidelines complete...",
    assignee: "Emma Park",
    assigneeRole: "Product Designer",
    date: "Apr 19",
    progress: 100,
