...
const JOBS = [
  {
    id: 1001,
    task: "Market Update Short",
    type: "Short Video",
    kind: "Video",
    platforms: ["youtube", "tiktok"] as PlatformKind[],
    status: "Rendering",
    statusTone: "warn",
    progress: 72,
    eta: "4m",
  ...
  {
    id: 1002,
    task: "Weekly Recap Reel",
    type: "Reel",
    kind: "Video",
    platforms: ["instagram", "tiktok"] as PlatformKind[],
    status: "In Progress",
    statusTone: "cyan",
    progress: 48,
    eta: "12m",
  ...
  {
    id: 1003,
    task: "Macro Brief Carousel",
    type: "Carousel",
    kind: "Image",
    platforms: ["instagram", "facebook"] as PlatformKind[],
    status: "Queued",
    statusTone: "muted",
    progress: 12,
    eta: "28m",
  ...
  {
    id: 1004,
    task: "Trading Psychology Tips",
    type: "Short Video",
    kind: "Video",
    platforms: ["youtube"] as PlatformKind[],
    status: "Editing",
    statusTone: "gold",
    progress: 61,
    eta: "9m",
  ...
  {
    id: 1005,
    task: "Thread: Liquidity Map",
    type: "Text",
    kind: "Text",
    platforms: ["facebook", "instagram"] as PlatformKind[],
    status: "Queued",
    statusTone: "muted",
    progress: 8,
    eta: "35m",
  ...
  {
    id: 1006,
    task: "Brand Kit Refresh",
    type: "Image",
    kind: "Image",
    platforms: ["instagram"] as PlatformKind[],
    status: "Completed",
    statusTone: "ok",
    progress: 100,
    eta: "—",
  ...
  {
    id: 1007,
    task: "Caption Batch · Q2",
    type: "Text",
    kind: "Text",
    platforms: ["youtube", "tiktok", "instagram"] as PlatformKind[],
    status: "In Progress",
    statusTone: "cyan",
    progress: 34,
    eta: "18m",
...
const CALENDAR = [
  {
    ...
    tags: ["Short Video", "Education"],
    platforms: ["youtube"] as PlatformKind[],
    thumb: mediaControlCrops.youtubeThumb1,
  },
  {
    when: "Apr 23 · 09:30",
    title: "Macro Brief Carousel",
    tags: ["Carousel", "Economy"],
    platforms: ["instagram", "facebook"] as PlatformKind[],
    thumb: mediaControlCrops.instagramReel1,
  },
  {
    when: "Apr 23 · 16:00",
    title: "Weekly Recap Reel",
    tags: ["Reel", "Markets"],
    platforms: ["tiktok", "instagram"] as PlatformKind[],
    thumb: mediaControlCrops.youtubeThumb2,
  },
  {
    when: "Apr 24 · 12:00",
    title: "Liquidity Map Thread",
    tags: ["Text", "Analysis"],
    platforms: ["facebook"] as PlatformKind[],
    thumb: mediaControlCrops.mediaPoster,
  },
  {
    when: "Apr 25 · 20:00",
    title: "Night Session Highlights",
    tags: ["Short Video", "Live"],
    platforms: ["youtube", "tiktok"] as PlatformKind[],
    thumb: mediaControlCrops.tiktokPoster,
  },
  {
    when: "Apr 27 · 11:00",
    title: "Brand Kit Drop",
    tags: ["Image", "Brand"],
    platforms: ["instagram"] as PlatformKind[],
    thumb: mediaControlCrops.instagramPoster,
  },
] as const;
...
const COMMENTS = [
  {
    user: "@alpha_trader",
    time: "12m",
    text: "This breakdown on liquidity voids is elite. More of these.",
  ...
  },
  {
    user: "@macro_mira",
    time: "34m",
    text: "Can you cover rate-cut odds next week?",
  ...
  },
  {
    user: "@clip_king",
    time: "1h",
    text: "Thumbnail game is strong — saved the carousel.",
    sentiment: "Positive" as const,
    unread: false,
  },
  {
    user: "@skeptic_42",
    time: "2h",
    text: "Audio levels dipped mid-reel. Fix for next one?",
  ...
  },
  {
    user: "@leviathan_fan",
    time: "3h",
    text: "@leviathan the psychology tips hit different.",
    sentiment: "Positive" as const,
    unread: false,
  },
] as const;
          ...
          <section className="lv-mc-panel">
            ...
            <div className="lv-mc-tabs" role="tablist">
              {PIPELINE_TABS.map((tab) => {
                const count =
                  tab === "All" ? JOBS.length : JOBS.filter((j) => j.kind === tab).length;
                return (
                  <button
                    key={tab}
                    type="button"
