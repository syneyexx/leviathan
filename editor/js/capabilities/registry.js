...
export function seedStudioCapabilities() {
  const rows = [
    ...
    ["ai-copilot", Status.IMPLEMENTED, "OmniRoute gateway + preview; providers optional"],
    ["ai-context-protocol", Status.IMPLEMENTED, "Editor Context Protocol v1"],
    ["ai-mock-provider", Status.IMPLEMENTED, "LEVIATHAN_EDITOR_AI_MOCK deterministic"],
    ["ai-capability-discovery", Status.IMPLEMENTED, "GET /api/editor-ai/capabilities"],
    ["ai-preview-accept", Status.IMPLEMENTED, "Temp promote + history capture"],
    ["ai-mcp-tool-foundation", Status.IMPLEMENTED, "js/ai/tools.js shared ops"],
