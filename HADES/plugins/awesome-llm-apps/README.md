# Awesome LLM Apps — HADES plugin

Installable `.HadesPlugin` wrapper around [https://github.com/Shubhamsaboo/awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps).
