# Antigravity Awesome Skills — HADES plugin

Installable `.HadesPlugin` wrapper around [https://github.com/benjaminasterA/antigravity-awesome-skills](https://github.com/benjaminasterA/antigravity-awesome-skills).
