# UI UX Pro Max — HADES plugin

Installable `.HadesPlugin` wrapper around [https://github.com/nextlevelbuilder/ui-ux-pro-max-skill](https://github.com/nextlevelbuilder/ui-ux-pro-max-skill).
