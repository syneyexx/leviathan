...
def server_command() -> list[str]:
    ...
    return [npx, *["-y", "chrome-devtools-mcp", "--no-usage-statistics"]]
...
def doctor() -> dict:
    ...
    payload = {
        ...
        "notes": [
            ...
            "list_tools/call_tool spawn chrome-devtools-mcp via npx -y.",
            "Live Chrome session quality is UNVERIFIED_ON_HOST without a browser.",
        ],
    }
    if not ok:
