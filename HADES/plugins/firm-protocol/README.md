# Firm Protocol — HADES plugin

Installable `.HadesPlugin` wrapper around [https://github.com/firm-org/firm-protocol](https://github.com/firm-org/firm-protocol).
...
Docs/skills only. No blockchain execution.
