# Diagram Design — HADES plugin

Installable `.HadesPlugin` wrapper around [https://github.com/cathrynlavery/diagram-design](https://github.com/cathrynlavery/diagram-design).
