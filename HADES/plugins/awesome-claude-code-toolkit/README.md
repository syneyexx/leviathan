# Awesome Claude Code Toolkit — HADES plugin

Installable `.HadesPlugin` wrapper around [https://github.com/rohitg00/awesome-claude-code-toolkit](https://github.com/rohitg00/awesome-claude-code-toolkit).
