# Awesome Claude Code — HADES plugin

Installable `.HadesPlugin` wrapper around [https://github.com/hesreallyhim/awesome-claude-code](https://github.com/hesreallyhim/awesome-claude-code).
