...
Installable `.HadesPlugin` wrapper around [https://github.com/trailhq/Graft](https://github.com/trailhq/Graft).
...
| `doctor` | See manifest |
| `index` | See manifest |
| `neighbors` | See manifest |
| `search` | See manifest |

Local import graph only. No Graft cloud service.
