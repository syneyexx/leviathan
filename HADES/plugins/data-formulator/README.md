# Data Formulator — HADES plugin

Installable `.HadesPlugin` wrapper around [https://github.com/microsoft/data-formulator](https://github.com/microsoft/data-formulator).
...
|------|---------|
| `doctor` | See manifest |
| `summarize` | See manifest |
| `chart` | See manifest |

Works fully offline on local CSV files.
