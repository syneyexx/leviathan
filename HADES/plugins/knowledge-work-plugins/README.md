# Knowledge Work Plugins — HADES plugin

Installable `.HadesPlugin` wrapper around [https://github.com/anthropics/knowledge-work-plugins](https://github.com/anthropics/knowledge-work-plugins).
...
Catalog + skills. Claude Cowork is not launched.
